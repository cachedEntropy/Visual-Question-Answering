...
from fusion import MLBFusion, MutanFusion
import config
...
class TextProcessor(nn.Module):
    ...
    def forward(self, q, q_len):
        ...
        # tanhed = tanhed.unsqueeze(0)
        # packed = pack_padded_sequence(tanhed, q_len[0], batch_first=True)
        tanhed = tanhed.permute(1,0,2)
        _, (_, c) = self.lstm(tanhed)

        # print('ALLLLLLAAAAAAAHHHHHH')
        # print(tanhed.shape)
        # print(c.shape)
